...
/* ÔöÇÔöÇ Local types ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
/* ÔöÇÔöÇ Helpers ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
const STAGE_LABELS = ["1┬¬ Vistoria", "2┬¬ Vistoria", "3┬¬ Vistoria"];
...
/* ÔöÇÔöÇ Component ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
export default function DashboardEstatisticas() {
  ...
  /* ÔöÇÔöÇ Filtering ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
  ...
  /* ÔöÇÔöÇ Compute statistics ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
  ...
  const stats = useMemo(() => {
    ...
    const stageData = [
      { name: "1┬¬ Vistoria", value: stage1 },
      { name: "2┬¬ Vistoria", value: stage2 },
      { name: "3┬¬ Vistoria", value: stage3 },
    ];
    ...
    const statusCounts = [
      ...
      { key: "certificado_termo", label: "Cert. Provis├│rio", count: byStatus["certificado_termo"] || 0 },
      { key: "pendencias", label: "Pend├¬ncia", count: byStatus["pendencias"] || 0 },
      { key: "expirado", label: "Expirados", count: byStatus["expirado"] || 0 },
      { key: "regional", label: "Aguardando", count: byStatus["regional"] || 0 },
      { key: "atribuido", label: "Atribu├¡do", count: byStatus["atribuido"] || 0 },
    ];

    // --- 3) Status by stage ---
    // rows: result types, columns: 1┬¬/2┬¬/3┬¬
  ...
  /* ÔöÇÔöÇ Render ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-foreground">Estat├¡sticas</h3>
        </div>
        <DateRangeFilter value={dateRange} onChange={setDateRange} />
      </div>

      {/* ÔöÇÔöÇ Row 1: Inspection stages + Status counts ÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Row 2: Status by stage table ÔöÇÔöÇ */}
      <div className="kpi-card">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                ...
                { key: "pendencia", label: "Pend├¬ncia", color: "text-status-pending" },
      ...
      {/* ÔöÇÔöÇ Row 3: Average times ÔöÇÔöÇ */}
      <div className="kpi-card">
        <div className="flex items-center gap-2 mb-4">
          <Timer className="w-4 h-4 text-primary" />
          <h4 className="text-sm font-semibold text-foreground">Tempos M├®dios (dias)</h4>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: "At├® 1┬¬ Vistoria", value: stats.avgTempos.primeiraVistoria, desc: "Solicita├º├úo ÔåÆ 1┬¬ vistoria" },
            { label: "1┬║ Retorno", value: stats.avgTempos.retorno1, desc: "1┬¬ vistoria ÔåÆ retorno" },
            { label: "2┬║ Retorno", value: stats.avgTempos.retorno2, desc: "2┬¬ vistoria ÔåÆ retorno" },
            { label: "At├® Certifica├º├úo", value: stats.avgTempos.certificacao, desc: "Solicita├º├úo ÔåÆ certifica├º├úo" },
          ].map((t) => (
            <div key={t.label} className="text-center p-3 rounded-xl bg-accent/50 space-y-1">
              <p className="text-2xl font-bold text-foreground">{t.value || "ÔÇö"}</p>
      ...
      {/* ÔöÇÔöÇ Row 4: By vistoriador + By regional ÔöÇÔöÇ */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {/* By vistoriador */}
        <div className="kpi-card">
          <div className="flex items-center gap-2 mb-4">
